...
?>
<table class="Article"><tr class="header"><td colspan="3"><b>статистика</b></td></tr>
<?
...
function genServerStatus() {
  $m = OMAGetServerStatus();
  ?><table class="Article"><tr class="header"><td colspan="3"><b>Server status</b></td></tr><?
  foreach ($m as $v) {
    $v1 = $v[1] ? "<font color=\"green\">Yes</div>" : "<font color=\"red\">No</div>";
    $v2 = $v[2] ? "<font color=\"green\">Yes</div>" : "<font color=\"red\">No</div>";
    ?><tr><td><?=$v[0]?></td><td><?=$v1?></td><td><?=$v2?></td></tr><?
  }
  ?></table><?
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td><? genStats(); ?><br><? genServerStatus(); ?></td><td>
